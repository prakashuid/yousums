  ...
  return (
      ...
      <div className="flex flex-col justify-center items-center">
        <h2 className="font-bold text-4xl">
          Save hours on Youtube with one click
        </h2>
        <Input
          className=" w-1/4 mt-20"
          type="text"
        ...
        {showProgress ? (
          <>
            ...
            <div className="">
              <h5>AI is Summarizing</h5>
              <p>Sit back and relax 🙂</p>
              <p>This video does not contain any captions</p>
            </div>
          </>
        ) : (
          ""
        )}
        {showError? <h2 className="mt-2">Paste your link ...</h2>:""}
